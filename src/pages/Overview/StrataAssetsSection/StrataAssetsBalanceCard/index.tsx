            ...
            <>
                <div css={styles.header}>
                    ...
                    <button css={styles.viewHistoryButton} onClick={() => setShowViewHistory(true)}>
                        ...
                        >
                            <path
                                d="M4.13391 3.39986L1.46724 5.39993C1.13763 5.64715 0.667237 5.41196 0.667237 4.99993L0.667236 0.999931C0.667236 0.587911 1.13761 0.35272 1.46723 0.599927L4.1339 2.59987C4.40057 2.79986 4.40057 3.19986 4.13391 3.39986Z"
                                fill="#90A0AC"
                                fillOpacity="0.8"
                            />
                        </svg>
                ...
                <Typography variant="h2" css={styles.balance}>
                    {balances == null ? (
                        ...
                        '$' + NumberUtil.abbr(balances.jrt.$ + balances.srt.$)
                    )}
                </Typography>
                        ...
                        <div css={styles.tokenInfo}>
                            ...
                            <div css={styles.tokenDetails}>
                                <div css={styles.tokenSymbol}>
                                    <span>srUSDe</span>
                                    <Tooltip
                                        mobileTitle={'srUSDe token'}
                                        title={
                                            'srUSDe is the senior risk tranche - an over-collateralized, yield-bearing dollar backed by USDe, offering a guaranteed min. yield with protected, uncapped upside.'
                                        }
                                    >
                                        <svg
                                            css={styles.infoIcon}
                        ...
                        <div css={styles.tokenBalances}>
                            <Typography variant="body1" css={styles.tokenAmount}>
                                {balances == null ? (
                                    ...
                                    NumberUtil.format(balances.srt.balance, { minFraction: 3 })
                                )}
                            </Typography>
                        ...
                        <div css={styles.tokenInfo}>
                            ...
                            <div css={styles.tokenDetails}>
                                <div css={styles.tokenSymbol}>
                                    <span>jrUSDe</span>
                                    <Tooltip
                                        mobileTitle={'jrUSDe token'}
                                        title={
                                            'jrUSDe represents the junior risk tranche, providing leveraged upside to sUSDe APY while serving as a liquid insurance pool for the senior tranche.'
                                        }
                                    >
                                        <svg
                                            css={styles.infoIcon}
                        ...
                        <div css={styles.tokenBalances}>
                            <Typography variant="body1" css={styles.tokenAmount}>
                                {balances == null ? (
                                    ...
                                    NumberUtil.format(balances.jrt.balance, { minFraction: 3 })
                                )}
                            </Typography>
                            <Typography variant="body2" css={styles.tokenValue}>
                                {balances == null ? (
