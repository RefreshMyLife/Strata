                ...
                <ConnectWallet message="Connect">
                    ...
                    <div css={styles.panelSection}>
                        <TransactionFormUi
                            ...
                            successfulTransactionTitle='Withdrawal Successful'
                            successfulTransactionDescription='Your pUSDe has been withdrawn successfully'
                            isTokenApproved={true}
                            approveToken={async () => ({} as any)}
                            isApproveTokenLoading={false}
                            isWalletSpendingLimitLoading={false}
                            revokeWalletSpendingLimit={async () => {}}
                    ...
                    <div css={styles.panelSection}>
                        ...
                        {canRequepUSDe && <TransactionFormUi
                            ...
                            successfulTransactionTitle='Withdrawal Request Successful'
                            successfulTransactionDescription='Your USDe withdrawal request has been submitted successfully'
                            isTokenApproved={true}
                            approveToken={async () => ({} as any)}
                            isApproveTokenLoading={false}
                            isWalletSpendingLimitLoading={false}
