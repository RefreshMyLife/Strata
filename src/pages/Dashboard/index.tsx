...
import { PointsGlobalBannerUiV2 } from '../Points/components/PointsGlobalBannerV2';
...
export const DashboardUi: React.FC<DashboardUiProps> = ({
    ...
    const hasIsolatedPools = isFeatureEnabled('isolatedPools');
    const hasIsolatedPoolsUI = true;
          ...
          <Trans
            ...
            components={{
              Link: (
                ...
                <a
                  href="https://community.strata.money/t/chaos-labs-risk-parameter-updates-08-21-2023/3707"
                  rel="noreferrer"
                />
              ),
            }}
      ...
      /> */}
            <div css={styles.header}>
                ...
                <div css={styles.headerBottomRow}>
                    {hasIsolatedPoolsUI && pools.length > 0 && (
                        <TagGroup
                            css={styles.tags}
                            tags={poolTags}
