...
export const VaultTable: React.FC<VaultTableProps> = ({ vaults }) => {
  ...
  const getSymbol = (vault: Vault) => {
    return vault.rewardToken.symbol[0].toLowerCase() + vault.stakedToken.symbol;
  };
    ...
    () => [
      {
        ...
        renderCell: vault => <TokenIconWithSymbol token={vault.stakedToken} symbol={getSymbol(vault)} />,
      },
      // {
      //   key: 'apr',
      ...
      //   renderCell: vault => {
      //     return formatPercentageToReadableValue(vault.stakingAprPercentage);
      //   },
