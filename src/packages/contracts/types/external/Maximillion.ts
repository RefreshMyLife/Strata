...
export interface MaximillionInterface extends utils.Interface {
  functions: {
    ...
    "seBnb()": FunctionFragment;
  };

  getFunction(
    nameOrSignatureOrTopic: "repayBehalf" | "repayBehalfExplicit" | "seBnb"
  ): FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "seBnb", values?: undefined): string;
  ...
  decodeFunctionResult(functionFragment: "seBnb", data: BytesLike): Result;
...
export interface Maximillion extends BaseContract {
  ...
  functions: {
    ...
    seBnb(overrides?: CallOverrides): Promise<[string]>;
  };
  ...
  estimateGas: {
    ...
    seBnb(overrides?: CallOverrides): Promise<BigNumber>;
  };
  ...
  populateTransaction: {
    ...
    seBnb(overrides?: CallOverrides): Promise<PopulatedTransaction>;
  };
}
