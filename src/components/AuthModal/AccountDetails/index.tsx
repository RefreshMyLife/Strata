...
import { PrimaryButton, QuinaryButton, SecondaryButton, TertiaryButton, TextButton } from '../../Button';
...
export const AccountDetails: React.FC<AccountDetailsProps> = ({
  ...
  return (
    <div css={styles.container}>
      ...
      <ScanLink css={styles.bscScanLinkContainer} hash={accountAddress} chainId={chainId} />

      <TextButton onClick={onLogOut} fullWidth>
