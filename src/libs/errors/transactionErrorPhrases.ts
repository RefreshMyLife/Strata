...
export const transactionErrorPhrases: Record<
  ...
  | keyof typeof SeUsdControllerErrorReporterError
  | keyof typeof SeUsdControllerErrorReporterFailureInfo,
  string
> = {
  ...
  INSUFFICIENT_BALANCE_FOR_SEUSD: t('transactionErrors.insufficientBalanceForSeUsd'),
  ...
  SET_SEUSD_MINT_RATE_CHECK: t('transactionErrors.setSeUsdMintRateCheck'),
  SET_SEUSDCONTROLLER_OWNER_CHECK: t('transactionErrors.setSeUsdControllerOwnerCheck'),
  SET_MINTED_SEUSD_REJECTION: t('transactionErrors.setMintedSeUsdRejection'),
  ...
  REPAY_SEUSD_COMPTROLLER_REJECTION: t('transactionErrors.repaySeUsdComptrollerRejection'),
  REPAY_SEUSD_FRESHNESS_CHECK: t('transactionErrors.repaySeUsdFreshnessCheck'),
  SEUSD_MINT_EXCHANGE_CALCULATION_FAILED: t('transactionErrors.seusdMintExchangeCalculationFailed'),
  ...
  SEUSD_MINT_REJECTION: t('transactionErrors.seusdMintRejection'),
  SEUSD_BURN_REJECTION: t('transactionErrors.seusdBurnRejection'),
  SEUSD_LIQUIDATE_ACCRUE_BORROW_INTEREST_FAILED: t(
    'transactionErrors.seusdLiquidateAccrueBorrowInterestFailed',
  ),
  SEUSD_LIQUIDATE_ACCRUE_COLLATERAL_INTEREST_FAILED: t(
    'transactionErrors.seusdLiquidateAccrueCollateralInterestFailed',
  ),
  SEUSD_LIQUIDATE_COLLATERAL_FRESHNESS_CHECK: t(
    'transactionErrors.seusdLiquidateCollateralFreshnessCheck',
  ),
  SEUSD_LIQUIDATE_COMPTROLLER_REJECTION: t('transactionErrors.seusdLiquidateComptrollerRejection'),
  SEUSD_LIQUIDATE_COMPTROLLER_CALCULATE_AMOUNT_SEIZE_FAILED: t(
    'transactionErrors.seusdLiquidateComptrollerCalculateAmountSeizeFailed',
  ),
  SEUSD_LIQUIDATE_CLOSE_AMOUNT_IS_UINT_MAX: t('transactionErrors.seusdLiquidateCloseAmountIsUintMax'),
  SEUSD_LIQUIDATE_CLOSE_AMOUNT_IS_ZERO: t('transactionErrors.seusdLiquidateCloseAmountIsZero'),
  SEUSD_LIQUIDATE_FRESHNESS_CHECK: t('transactionErrors.seusdLiquidateFreshnessCheck'),
  SEUSD_LIQUIDATE_LIQUIDATOR_IS_BORROWER: t('transactionErrors.seusdLiquidateLiquidatorIsBorrower'),
  SEUSD_LIQUIDATE_REPAY_BORROW_FRESH_FAILED: t(
    'transactionErrors.seusdLiquidateRepayBorrowFreshFailed',
  ),
  SEUSD_LIQUIDATE_SEIZE_BALANCE_INCREMENT_FAILED: t(
    'transactionErrors.seusdLiquidateSeizeBalanceIncrementFailed',
  ),
  SEUSD_LIQUIDATE_SEIZE_BALANCE_DECREMENT_FAILED: t(
    'transactionErrors.seusdLiquidateSeizeBalanceDecrementFailed',
  ),
  SEUSD_LIQUIDATE_SEIZE_COMPTROLLER_REJECTION: t(
    'transactionErrors.seusdLiquidateSeizeComptrollerRejection',
  ),
  SEUSD_LIQUIDATE_SEIZE_LIQUIDATOR_IS_BORROWER: t(
    'transactionErrors.seusdLiquidateSeizeLiquidatorIsBorrower',
  ),
  SEUSD_LIQUIDATE_SEIZE_TOO_MUCH: t('transactionErrors.seusdLiquidateSeizeTooMuch'),
